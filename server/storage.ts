...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    const samplePupils: Pupil[] = [
      ...
      },
      {
        ...
        isParentRepresentative: 0,
        privacyPolicyAccepted: 1,
        privacyPolicyAcceptedDate: "2024-02-01",
        contractAccepted: 1,
        contractAcceptedDate: "2024-02-01",
        educationConsentAccepted: 1,
        educationConsentAcceptedDate: "2024-02-01",
        parentFirstName: null,
        parentLastName: null,
        parentMiddleName: null,
        parentPhone: null,
    ...
    const chestExercises: Exercise[] = [
      {
        ...
        primaryMuscles: JSON.stringify(["грудь"]),
        secondaryMuscles: JSON.stringify(["плечи", "руки"]),
        difficulty: "средний",
        ...
        contraindications: JSON.stringify(["травмы плечевого сустава", "боли в спине"]),
        muscleImageUrl: null,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["травмы плечевого сустава"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        primaryMuscles: JSON.stringify(["грудь"]),
        secondaryMuscles: JSON.stringify(["плечи"]),
        difficulty: "средний",
      ...
      },
      {
        ...
        primaryMuscles: JSON.stringify(["грудь"]),
        secondaryMuscles: JSON.stringify(["плечи", "руки", "живот"]),
        difficulty: "начинающий",
        ...
        contraindications: JSON.stringify(["травмы запястий", "боли в пояснице"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["травмы коленей", "травмы запястий"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["травмы плечевого сустава", "проблемы с шейным отделом"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["травмы плечевого сустава", "травмы запястий", "проблемы с локтевыми суставами"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["проблемы с давлением", "травмы шейного отдела", "головокружения"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        primaryMuscles: JSON.stringify(["грудь"]),
        secondaryMuscles: JSON.stringify(["спина", "плечи"]),
        difficulty: "средний",
        ...
        contraindications: JSON.stringify(["травмы плечевого сустава", "проблемы с позвоночником"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["острые травмы плечевого сустава"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["проблемы с давлением", "травмы запястий"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
    ...
    const backExercises: Exercise[] = [
      {
        id: 17,
        name: "Становая тяга",
        primaryMuscles: JSON.stringify(["спина"]),
        secondaryMuscles: JSON.stringify(["ноги", "ягодичные", "руки"]),
        difficulty: "продвинутый",
        ...
        contraindications: JSON.stringify(["травмы позвоночника", "грыжи", "проблемы с поясницей"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        primaryMuscles: JSON.stringify(["спина"]),
        secondaryMuscles: JSON.stringify(["руки", "плечи"]),
        difficulty: "средний",
        ...
        contraindications: JSON.stringify(["травмы плечевых суставов", "травмы запястий"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["проблемы с поясницей", "травмы позвоночника"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["травмы плечевых суставов"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["проблемы с поясницей"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        primaryMuscles: JSON.stringify(["спина"]),
        secondaryMuscles: JSON.stringify(["руки"]),
        difficulty: "средний",
      ...
      },
      {
        ...
        name: "Гиперэкстензия",
        primaryMuscles: JSON.stringify(["спина"]),
        secondaryMuscles: JSON.stringify(["ягодичные"]),
        difficulty: "начинающий",
        ...
        contraindications: JSON.stringify(["острые боли в пояснице", "грыжи позвоночника"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        contraindications: JSON.stringify(["травмы шейного отдела"]),
        muscleImageUrl: null,
        techniqueImageUrl: null,
        videoUrl: null,
        createdBy: 1,
      ...
      },
      {
        ...
        primaryMuscles: JSON.stringify(["спина"]),
        secondaryMuscles: JSON.stringify(["грудь", "плечи"]),
        difficulty: "средний",
    ...
    const session1: WorkoutSession = {
      ...
      userId: 1,
      programId: 1,
      scheduledDate: new Date(todayString + 'T14:00:00').toISOString(),
      startTime: "14:00",
      endTime: "16:00",
      status: "scheduled",
      completedAt: null,
    ...
    const session2: WorkoutSession = {
      ...
      userId: 1,
      programId: 2,
      scheduledDate: new Date(todayString + 'T18:00:00').toISOString(),
      startTime: "18:00",
      endTime: "19:00",
      status: "scheduled",
      completedAt: null,
  ...
  async createUser(insertUser: InsertUser): Promise<User> {
    ...
    const user: User = { 
      ...insertUser, 
      id,
      isTrainer: insertUser.isTrainer ? 1 : 0,
  ...
  async createExercise(insertExercise: InsertExercise): Promise<Exercise> {
    ...
    const exercise: Exercise = { 
      ...insertExercise, 
      id,
      secondaryMuscles: insertExercise.secondaryMuscles ?? JSON.stringify([]),
  ...
  async createPupil(insertPupil: InsertPupil): Promise<Pupil> {
    ...
    const pupil: Pupil = { 
      id,
      trainerId: insertPupil.trainerId ?? null,
      firstName: insertPupil.firstName,
      lastName: insertPupil.lastName,
      middleName: insertPupil.middleName ?? null,
      phone: insertPupil.phone,
      email: insertPupil.email,
      password: insertPupil.password,
      birthDate: insertPupil.birthDate,
      ...
      joinDate: insertPupil.joinDate ?? new Date().toISOString().split('T')[0],
      isParentRepresentative: insertPupil.isParentRepresentative ?? 0,
      privacyPolicyAccepted: insertPupil.privacyPolicyAccepted ?? 0,
      privacyPolicyAcceptedDate: insertPupil.privacyPolicyAcceptedDate ?? null,
      contractAccepted: insertPupil.contractAccepted ?? 0,
      contractAcceptedDate: insertPupil.contractAcceptedDate ?? null,
      educationConsentAccepted: insertPupil.educationConsentAccepted ?? 0,
      educationConsentAcceptedDate: insertPupil.educationConsentAcceptedDate ?? null,
  ...
  async createPupilTrainingPlan(insertPlan: InsertPupilTrainingPlan): Promise<PupilTrainingPlan> {
    ...
    const plan: PupilTrainingPlan = { 
      ...
      trainerId: insertPlan.trainerId,
      exercises: insertPlan.exercises,
      pupilId: insertPlan.pupilId,
      isActive: insertPlan.isActive ? 1 : 0,
      createdAt: insertPlan.createdAt ?? new Date().toISOString(),
      updatedAt: insertPlan.updatedAt ?? new Date().toISOString()
    };
  ...
  async authenticatePupil(emailOrPhone: string, password: string): Promise<Pupil | undefined> {
    ...
    for (const pupil of Array.from(this.pupils.values())) {
      if ((pupil.email === emailOrPhone || pupil.phone === emailOrPhone) && pupil.password === password) {
        return pupil;
      }
    }
    return undefined;
  ...
  async registerPupil(pupil: InsertPupil): Promise<Pupil> {
    const newPupil: Pupil = {
      ...
      trainerId: pupil.trainerId ?? null,
      weight: pupil.weight ?? null,
      height: pupil.height ?? null,
      goal: pupil.goal ?? null,
      medicalNotes: pupil.medicalNotes ?? null,
      photo: pupil.photo ?? null,
      joinDate: pupil.joinDate ?? new Date().toISOString().split('T')[0],
      isParentRepresentative: pupil.isParentRepresentative ?? 0,
      privacyPolicyAccepted: pupil.privacyPolicyAccepted ?? 0,
      privacyPolicyAcceptedDate: pupil.privacyPolicyAcceptedDate ?? null,
      contractAccepted: pupil.contractAccepted ?? 0,
      contractAcceptedDate: pupil.contractAcceptedDate ?? null,
      educationConsentAccepted: pupil.educationConsentAccepted ?? 0,
      educationConsentAcceptedDate: pupil.educationConsentAcceptedDate ?? null,
      parentFirstName: pupil.parentFirstName ?? null,
      parentLastName: pupil.parentLastName ?? null,
      parentMiddleName: pupil.parentMiddleName ?? null,
      parentPhone: pupil.parentPhone ?? null,
      parentEmail: pupil.parentEmail ?? null,
      parentSpecialInstructions: pupil.parentSpecialInstructions ?? null,
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    };
    this.pupils.set(newPupil.id, newPupil);
    return newPupil;
  }

  async getPupilByEmail(email: string): Promise<Pupil | undefined> {
    for (const pupil of Array.from(this.pupils.values())) {
      if (pupil.email === email) {
        return pupil;
      }
    }
    return undefined;
  ...
  // Trainer authentication methods
...
export class DatabaseStorage implements IStorage {
  ...
  async getWorkoutSessionsByDate(userId: number, date: string): Promise<WorkoutSession[]> {
    ...
    return await db.select().from(workoutSessions).where(
      and(
        ...
        eq(workoutSessions.scheduledDate, date)
      )
    );
  }
  ...
  async getActiveTrainingPlan(pupilId: number): Promise<PupilTrainingPlan | undefined> {
    ...
    const [plan] = await db.select().from(pupilTrainingPlans).where(
      and(
        ...
        eq(pupilTrainingPlans.isActive, 1)
      )
    );
    return plan;
  }
  ...
  async createPupilTrainingPlan(insertPlan: InsertPupilTrainingPlan): Promise<PupilTrainingPlan> {
    const { db } = await import("./db");
    const [plan] = await db.insert(pupilTrainingPlans).values({
      name: insertPlan.name,
      trainerId: insertPlan.trainerId,
      exercises: insertPlan.exercises,
      pupilId: insertPlan.pupilId,
  ...
  async createPupil(insertPupil: InsertPupil): Promise<Pupil> {
    try {
      ...
      const [pupil] = await db.insert(pupils).values({
        password: insertPupil.password,
        firstName: insertPupil.firstName,
        lastName: insertPupil.lastName,
        middleName: insertPupil.middleName ?? null,
        ...
        educationConsentAccepted: insertPupil.educationConsentAccepted ?? 0,
        educationConsentAcceptedDate: insertPupil.educationConsentAcceptedDate ?? null,
        // gender: insertPupil.gender ?? null,
        // address: insertPupil.address ?? null,
        // emergencyContact: insertPupil.emergencyContact ?? null,
        // emergencyPhone: insertPupil.emergencyPhone ?? null,
        // medicalInfo: insertPupil.medicalInfo ?? null,
        // goals: insertPupil.goals ?? null,
        // experience: insertPupil.experience ?? null,
        // preferences: insertPupil.preferences ?? null,
        parentFirstName: insertPupil.parentFirstName ?? null,
        parentLastName: insertPupil.parentLastName ?? null,
        parentMiddleName: insertPupil.parentMiddleName ?? null,
        parentPhone: insertPupil.parentPhone ?? null,
  ...
  async authenticatePupil(emailOrPhone: string, password: string): Promise<Pupil | undefined> {
    ...
    const [pupil] = await db
      ...
      .where(
        or(
          eq(pupils.email, emailOrPhone),
          eq(pupils.phone, emailOrPhone)
        )
      );
    
    if (pupil && pupil.password === password) {
      return pupil;
    }
    return undefined;
  }
