...
- January 5, 2025. Восстановлена система прикрепления планов к ученикам: добавлена кнопка "Прикрепить" на готовых планах, кнопка "Выбрать ученика" на создании тренировок, диалог выбора ученика с автоматическим прикреплением через ActiveWorkout контекст
